...
def main():
    parser = argparse.ArgumentParser(description='Plot Figure 16a - Parallelization Factor Sweep')
    parser.add_argument('--json', type=str, default='figure16_results.json',
                        help='Path to JSON file with results')
    parser.add_argument('--output', type=str, default='figure16a_par_sweep.pdf',
